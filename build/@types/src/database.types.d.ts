export declare type WeatherGeolocationTypes = {
    id: number;
    fullLocation: string;
    location1: string;
    location2: string;
...
export declare type WeatherDailyTypes = {
    id: number;
    updateTime: string;
    location: string;
...
export declare type WeatherThreeHoursTypes = {
    id: number;
    updateTime: string;
    location: string;
    precipitationState: string;
...
export declare type WeatherAtmosTypes = {
    id: number;
    updateTime: string;
    location: string;
...
export declare type WeatherWeeklyTypes = {
    id: number;
    location: string;
    updateTime: string;
    day1: string;
